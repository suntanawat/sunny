 ...
 */
public class Enemy2 extends UIScreen {
    ...
    public Enemy2()
    {
        Image bgImage1 = assets().getImage("images/enemy22.png");
        Image bgImage2 = assets().getImage("images/enemy1.png");
        int n=rand.nextInt(2);
        if (n==0){bgLayer = graphics().createImageLayer(bgImage1);}
        else {bgLayer = graphics().createImageLayer(bgImage2);}
